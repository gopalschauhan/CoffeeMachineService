namespace CoffeeMachine.Application.Models.Constants
{
    public static class ApplicationConstants
    {
        public const string APIPermitRateLimit = "RateLimit:PermitLimit";
        public const string APIRateLimitQueue = "RateLimit:QueueLimit";
